...
public class JwtUtil1 {
    ...
    private final String BASEKEY="dslkjaflks2djflaksjoewiurqoewiroawwejrlwakjerkjawrlekjalwkjerfeirusaew1oaiwejrldskjf34lksadjfalk4jf!!!";
    //토큰생성하는 메소드
    public String createJwt( String id, String name ) throws Exception{
        ...
        expiredTime.setTime(expiredTime.getTime()+1000*60*60*8);//8시간
        ...
        //1~4의 정보를 이용해서 토큰 생성
        JwtBuilder builder=Jwts.builder().setHeader(headerMap).setClaims(claimsMap).setSubject("TEST").setExpiration(expiredTime).signWith(signKey,SignatureAlgorithm.HS256);
